...
/** 当前导航元素宽度 */
const navItemWidth = useCssVar('--lc-nav-item-width', headerRef)
/** 当前导航元素高度 */
const navItemHeight = useCssVar('--lc-nav-item-height', headerRef)
/** 导航背景元素可见性 */
const navAfterVisibility = useCssVar('--lc-nav-after-visibility', headerRef)
/** 导航背景元素透明度 */
const navAfterOpacity = useCssVar('--lc-nav-after-opacity', headerRef)
/** 导航背景元素定位 */
const navAfterLeft = useCssVar('--lc-nav-after-left', headerRef)
/** 导航背景元素过渡属性 */
const navAfterTransition = useCssVar('--lc-nav-after-transition', headerRef)
/** 阻止鼠标事件 */
const navLockerPointerEvents = useCssVar('--lc-nav-locker-pointer-events', headerRef)
